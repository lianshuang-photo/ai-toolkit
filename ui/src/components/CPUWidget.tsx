      ...
      <div className="bg-gray-900 rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border border-gray-800">
        <div className="bg-gray-800 px-4 py-3 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <h2 className="font-semibold text-gray-100">CPU 信息 (CPU Info)</h2>
          </div>
        </div>
        <div className="p-4">
          <p className="text-sm text-gray-400">无 CPU 数据 (No CPU data available)</p>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="">
            <div className="flex items-center space-x-2 mb-1 mt-1">
              ...
              <p className="text-xs text-gray-400">CPU 负载 (CPU Load)</p>
          ...
          <div>
            <div className="flex items-center space-x-2 mb-1 mt-1">
              ...
              <p className="text-xs text-gray-400">内存 (Memory)</p>
