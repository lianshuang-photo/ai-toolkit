...
const Sidebar = () => {
  const navigation = [
    { name: '仪表盘 (Dashboard)', href: '/dashboard', icon: Home },
    { name: '新建任务 (New Job)', href: '/jobs/new', icon: Plus },
    { name: '训练队列 (Training Queue)', href: '/jobs', icon: BrainCircuit },
    { name: '数据集 (Datasets)', href: '/datasets', icon: Images },
  ...
  return (
    <div className="flex flex-col w-59 bg-gray-900 text-gray-100">
      ...
      >
        ...
        <div className="uppercase text-gray-500 text-sm mb-2 flex-1 pt-2 pl-0">支持 AI-Toolkit (Support)</div>
      </a>
