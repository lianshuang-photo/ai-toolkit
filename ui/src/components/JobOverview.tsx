        ...
        <div className="p-4 space-y-6 flex flex-col flex-grow">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              <span className="text-gray-400">进度 (Progress)</span>
              <span className="text-gray-200">
                步数 (Step) {job.step} / {totalSteps}
              </span>
            </div>
          ...
          <div className="grid gap-4 grid-cols-1 md:grid-cols-3">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-xs text-gray-400">任务名称 (Job Name)</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-xs text-gray-400">分配的 GPU (Assigned GPUs)</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-xs text-gray-400">速度 (Speed)</p>
          ...
          <div className="bg-gray-950 rounded-lg p-4 relative flex-grow min-h-60">
            ...
            >
              {statusLog === 'loading' && '加载日志中... (Loading log...)'}
              {statusLog === 'error' && '加载日志出错 (Error loading log)'}
