            ...
            <div className="bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="text-center">
                <DialogTitle as="h3" className="text-base font-semibold text-gray-200 mb-4">
                  添加图片到 (Add Images to): {addImagesModalInfo?.datasetName}
                </DialogTitle>
                <div className="w-full">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-200 text-center">
                      {isDragActive ? '将文件拖放到此处... (Drop the files here...)' : '拖放文件到此处，或点击选择文件 (Drag & drop files here, or click to select files)'}
                    </p>
                  </div>
                  {isUploading && (
                    <div className="mt-4">
                      ...
                      <p className="text-sm text-gray-300 mt-2 text-center">上传中... (Uploading...) {uploadProgress}%</p>
                    </div>
                  )}
                </div>
              </div>
