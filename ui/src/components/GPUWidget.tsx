      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-xs text-gray-400">温度 (Temperature)</p>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-xs text-gray-400">风扇速度 (Fan Speed)</p>
          ...
          <div>
            <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-xs text-gray-400">GPU 负载 (GPU Load)</p>
            ...
            <div className="flex items-center space-x-2 mb-1 mt-3">
              ...
              <p className="text-xs text-gray-400">显存 (Memory)</p>
        ...
        <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-800">
          <div className="flex items-start space-x-2">
            ...
            <div>
              <p className="text-xs text-gray-400">时钟速度 (Clock Speed)</p>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              <p className="text-xs text-gray-400">功耗 (Power Draw)</p>
